...
class Offer
{
    ...
    #[ORM\OneToMany(targetEntity: Images::class, mappedBy: 'offer', orphanRemoval: true)]
    ...
    #[ORM\OneToMany(targetEntity: Review::class, mappedBy: 'offer', orphanRemoval: true)]
    private Collection $reviews;

    #[ORM\OneToMany(targetEntity: Booking::class, mappedBy: 'offer', orphanRemoval: true)]
